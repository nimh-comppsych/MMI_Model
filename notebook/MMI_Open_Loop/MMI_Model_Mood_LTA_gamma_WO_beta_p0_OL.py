...
# load matplotlib inline mode
#matplotlib inline
def mmi_model_Mood_LTA_gamma_WO_beta_p0(subj_input_dir,subj_out_dir,sid):
    ...
    from mmi_mood_LTA_gamma_WO_beta_p0_OL import MMIModel, load_mmi_data
...
if __name__ == '__main__':
    mmi_model_Mood_LTA_gamma_WO_beta_p0()                        
