...
# load matplotlib inline mode
#matplotlib inline
def mmi_model_Mood_LTA_gamma_wo_RT(subj_input_dir,subj_out_dir,sid):
    ...
    from mmi_mood_LTA_gamma_wo_RT_OL import MMIModel, load_mmi_data
...
#     dat.at[2, 'Choice']=='Gamble'
    ...
    pickle_name=subj_out_dir / f'Mood_LTA_mWgt_{sid}.pickle'
    print(pickle_name)
    ...
    print("Best fitting params:")
    pp = get_best_fit(m, burnin=250, verbose=True)
    pickle_name=subj_out_dir / f'Mood_LTA_mBFprm_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
    ...
    pickle_name=subj_out_dir / f'Mood_LTA_Mood_BPIC_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
    ...
    pickle_name=subj_out_dir / f'Mood_LTA_RT_BPIC_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
    ...
    pickle_name=subj_out_dir / f'Mood_LTA_Total_mBPIC_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
...
#         plt.title(m.param_names[i])
    ...
    pickle_name=subj_out_dir / f'Mood_LTA_mParticles_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
    pickle.dump(m.particles, pickle_out)
    pickle_out.close()
                        
    pickle_name=subj_out_dir / f'Mood_LTA_mParams_{sid}.pickle'
    print(pickle_name)
    pickle_out = open(pickle_name,"wb")
...
if __name__ == '__main__':
    mmi_model_Mood_LTA_gamma_wo_RT()                        
