...
# load matplotlib inline mode
#matplotlib inline
def mmi_model_Mood_LTA_gamma_1_wo_RT_p0_beta(subj_input_dir,subj_out_dir,sid):
    ...
    from mmi_mood_LTA_gamma_1_wo_RT_p0_beta_OL import MMIModel, load_mmi_data
...
if __name__ == '__main__':
    mmi_model_Mood_LTA_gamma_1_wo_RT_p0_beta()                        
