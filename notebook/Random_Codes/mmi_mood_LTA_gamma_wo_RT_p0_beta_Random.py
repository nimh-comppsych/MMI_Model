...
def load_mmi_data(filename):
    ...
    # GetAnswer_RT
    cols = ['CertainAmount', 'Outcome1Amount', 'Outcome2Amount', 'Outcome', 'GetAnswer.RT',
            'TrialHappiness.SliderResp', 'DoRating', 'CurrentAmount'
           ]
    dat = dat[cols]

    # add useful columns
    # first rename some
    dat['RT'] = dat['GetAnswer.RT']/1000.
    dat['Mood'] = dat['TrialHappiness.SliderResp']
